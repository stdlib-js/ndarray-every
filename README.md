...
```javascript
import every from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-every@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-every@v0.1.1-esm/index.mjs';
```
